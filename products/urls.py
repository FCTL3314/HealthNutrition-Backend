...
urlpatterns = [
    ...
    path(
        "search/redirect/", views.SearchRedirectView.as_view(), name="search-redirect"
    ),
    path(
        "search/products/", views.ProductSearchListView.as_view(), name="product-search"
    ),
    path(
        "search/product-types/",
        views.ProductTypeSearchListView.as_view(),
