...
urlpatterns = [
    ...
    path('search/product/', ProductSearchListView.as_view(), name='product-search'),
    path('search/product-type/', ProductTypeSearchListView.as_view(), name='product-type-search'),
]
